...
| `--with-worker` | Included by default | `apps/api/app/worker.py`, `apps/api/tests/core/test_tasks.py` | `HATCHET_CLIENT_TOKEN` | Uses Hatchet Cloud and does not require Redis. |
