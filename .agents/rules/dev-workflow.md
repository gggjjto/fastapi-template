...
| --------------------------------------------- | ---------------------------------------- | -------------------------------------------------------- |
| **AI instructions** (this file + `AGENTS.md`) | Agent should run gates after edits       | Catches issues before you commit                         |
...
Before committing, check whether the change affects setup, APIs, configuration, tests, CI/CD, security posture, or AI workflow. If it does, update the smallest relevant document according to `.agents/rules/docs-maintenance.md`.
