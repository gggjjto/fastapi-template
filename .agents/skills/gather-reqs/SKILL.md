...
Use this skill before starting a new feature or significant change. Goal: produce a clear, agreed spec that `/feature` can consume directly, and save it to `.agents/requirements.md`.
...
Append to `.agents/requirements.md`:
...
2. Confirmation that `.agents/requirements.md` was updated.
